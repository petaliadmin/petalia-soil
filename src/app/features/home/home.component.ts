    ...
    <section class="py-20 md:py-28 bg-white dark:bg-gray-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- Feature 2 -->
          <div class="card p-8 text-center group">
            <div class="w-16 h-16 mx-auto mb-6 bg-amber-100 dark:bg-amber-900/50 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Analyse du Sol</h3>
            <p class="text-gray-600 dark:text-gray-400">
              Consultez les parametres detailles du sol : pH, NPK, texture, humidite et plus encore.
            </p>
          </div>
